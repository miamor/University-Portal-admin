...
<form id="theform" class="form-new">
	...
	<div class="form-group form-type_action">
        ...
        <div class="col-lg-3 no-padding">
            <label><input name="sex" type="radio" checked value="true"> Nam</label>
		</div>
	...
	<div class="form-group form-type_action">
		...
		<div class="col-lg-3 no-padding">
            <label><input name="status" type="radio" checked value="true"> Activate</label>
		</div>
		<div class="col-lg-4 no-padding">
